            ...
            <div className="flex gap-4">
              <div className="flex-1">
                <p className="text-base leading-relaxed">
                  ...
                  <a href="https://www.sciencedirect.com/science/article/pii/S1050464813001666" className="hover:underline" style={{ color: 'rgb(147, 51, 234)' }}>A single whey acidic protein domain containing protein (SWD) inhibits bacteria invasion and dissemination in shrimp Marsupenaeus japonicus</a>.{' '}
